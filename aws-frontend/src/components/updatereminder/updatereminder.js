...
export default function UpdateReminder({ type, reminder, onSubmit, onCancel }) {
    ...
    const handleUpdate = () => {
        ...
        if (type === "add") {
            axios.post('http://cloudfinal-backend-alb-1135630707.us-west-2.elb.amazonaws.com:8000/reminder', {
                ...localReminder,
            ...
            axios.put('http://cloudfinal-backend-alb-1135630707.us-west-2.elb.amazonaws.com:8000/reminder', {
                "user_id": localStorage.getItem("userId"),
