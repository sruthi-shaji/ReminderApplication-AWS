...
export default function UpdateReminder({ type, reminder, onSubmit, onCancel }) {
    ...
    const handleUpdate = () => {
        ...
        if (type === "add") {
            axios.post('http://remindo-cloud-backend-alb-1439002831.us-east-1.elb.amazonaws.com:8000/reminder', {
                ...localReminder,
            ...
            axios.put('http://remindo-cloud-backend-alb-1439002831.us-east-1.elb.amazonaws.com:8000/reminder', {
                "user_id": localStorage.getItem("userId"),
